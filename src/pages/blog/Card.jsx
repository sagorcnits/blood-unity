...
const Card = () => {
  return (
    <div className="flex flex-col  p-6 space-y-6 overflow-hidden rounded-lg shadow-md border font-open-sans">
      <div>
        <img
          src="https://img.freepik.com/free-photo/world-blood-donor-day-creative-collage_23-2149378359.jpg?t=st=1717436089~exp=1717439689~hmac=5e7f80620225eaf19317aeab779061dd6709bf8807dc1b756ade0e33e377ab2c&w=826"
          alt=""
      ...
      <div className="flex flex-wrap justify-between">
        <Link className="text-[20px] text-darkRed font-bold">Read More...</Link>
