      ...
      <div className="flex flex-col-reverse md:flex-row items-center font-open-sans">
        <div>
          <form className="md:w-[70%] mx-auto">
            ...
            <input type="text" placeholder="Name" className="input input-bordered w-full mt-4 " />
            <input type="email" placeholder="Email" className="input input-bordered w-full mt-4 " />
            <input type="number" placeholder="Number" className="input input-bordered w-full mt-4 " />
            <textarea
